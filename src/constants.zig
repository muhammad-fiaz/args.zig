...
pub const ValidationMessages = struct {
    ...
    pub const invalid_unix_timestamp = "invalid Unix timestamp (expected positive integer)";
    pub const invalid_date_flexible = "invalid date (expected YYYY-MM-DD, DD/MM/YYYY, MM/DD/YYYY, or YYYY/MM/DD)";
