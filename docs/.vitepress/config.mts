      ...
      "/guide/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Prompt Interaction", link: "/guide/prompt-interaction" },
      ...
      "/api/": [
        {
          ...
          items: [
            ...
            { text: "ParseResult", link: "/api/result" },
            { text: "ParsedValue", link: "/api/parsed-value" },
            { text: "Types", link: "/api/types" },
            { text: "Errors", link: "/api/errors" },
            { text: "Constants", link: "/api/constants" },
            { text: "Export API", link: "/api/export" },
          ],
        },
      ],
      "/examples/": [
